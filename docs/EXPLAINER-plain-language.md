...
SHA-1-pinned draw across nine strata (maps, charts, diagrams, logos, multilingual, embedded raster and more). The
gap: the community has good test suites for SVG *renderers* (User:JoKalliauer's), none for SVG *editors*.
...
narrow and surgical: SVG Translate (2017, #9), inserting translation blocks instead of rewriting.
